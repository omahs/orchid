...
class Parser {
  ...
  Object fail({Token? tok, String? expected, String? message}) {
    ...
    throw new ParseError(
        message, filename ?? 'no filename', tok.line, tok.startOffset, tok.endOffset);
  }
  ...
  Name makeName(Token tok) => new Name(tok.value ?? 'null')
